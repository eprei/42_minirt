...
SRCS = ft_toupper.c ft_tolower.c ft_strrchr.c ft_strncmp.c \
	ft_strlen.c ft_strchr.c ft_putstr_fd.c ft_putnbr_fd.c \
	ft_putchar_fd.c ft_isprint.c ft_isdigit.c ft_isascii.c \
